$(document).ready(function () {
  ...
  $("a.abstract").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.award").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.bibtex").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.quotes").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.speakers").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.video").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.audio").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.figures").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .photos.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.photos").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .documents.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.documents").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .gallery.hidden.open"
      )
      .removeClass("open");
  ...
  $("a.gallery").click(function () {
    ...
    $(this)
      ...
      .parent()
      .find(
        ".abstract.hidden.open, .award.hidden.open, .bibtex.hidden.open, .quotes.hidden.open, .speakers.hidden.open, .video.hidden.open, .audio.hidden.open, .figures.hidden.open, .photos.hidden.open, .documents.hidden.open"
      )
      .removeClass("open");
