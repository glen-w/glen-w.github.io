# Application for Policy Communication (vacancy 4103) ([IUCN](https://www.iucn.org))

Junior Policy-Communications Officer
Vacancy #:               4103
Unit:                    EURO - EU Policies
Organization:            International Union for Conservation of Nature (IUCN) Location:                European Regional Office, Brussels, Belgium
...
Vacancy Details - IUCN HR Management System (https://hrms.iucn.org)                                                  Page 1 / 2
...
https://hrms.iucn.org/vacancy/4103
...
Vacancy Details - IUCN HR Management System (https://hrms.iucn.org)                                                  Page 2 / 2

The first priority is promoting protected areas and nature-based solutions that provide environmental benefits and support livelihoods, focussing on: 1. establishing a connected global network of effectively managed protected areas; and 2. protecting and restoring "blue carbon" ecosystems, such as mangroves. Ecosystem-based fisheries management, including dynamic management mechanisms, is also needed to respond to stock shifts and secure the role of living resources in the carbon cycle.

As climate change demands cross-sectoral and transformative action at all scales, the second priority is to address systemic issues, particularly in governance and finance.

Coherence between climate and ocean governance frameworks is needed. At the national level, this could include factoring climate into marine planning. At the global level, ocean commitments should form part of Nationally Determined Contributions under the Paris Agreement and be fully integrated into the Post-2020 Global Biodiversity Framework. In turn, climate should be addressed in a high seas treaty.

The priority for finance is unlocking private investment for blue natural capital, in particular by supporting the development of projects that pair clear benefits for ecosystems and communities with reliable income for investors. This could also include work to overcome legal barriers, develop effective management and monitoring, and strengthen the science.

A final priority is to urge caution where activities compound existing impacts and reduce resilience. There is an opportunity to implement strict regulations for novel activities, e.g. seabed mining and mesopelagic fishing. Established practices, such as bottom trawling, could also be highlighted where growing evidence demonstrates significant climate impacts.
