...
speakers:
  ...
  - Fabio Feldmann, Executive Secretary, Paulista Forum on Global Climate Change and
    Biodiversity (Brazil)
  ...
  - Lindiwe Majele Sibanda, CEO, Food, Agriculture and Natural Resources Policy Analysis
    Network (South Africa)
preview: 2012_fair_ideas_sharing_solutions_sustainable_planet
...
resources:
  - kind: pdf
    ...
    url: /assets/pdf/2012_fair_ideas_sharing_solutions_sustainable_planet.pdf
    format: PDF
    local: true
    external: false
    primary: true
