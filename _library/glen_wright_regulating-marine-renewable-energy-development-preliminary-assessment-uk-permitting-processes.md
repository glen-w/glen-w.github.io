...
resources:
- kind: pdf
  title: 'Regulating marine renewable energy development: a preliminary assessment
    of UK permitting processes'
  label: View primary document
  url: /assets/pdf/glen_wright_2014_regulating_marine_renewable_energy_development_preliminary_assessment_uk_permitting_processes.pdf
  format: PDF
  local: true
  external: false
  primary: true
