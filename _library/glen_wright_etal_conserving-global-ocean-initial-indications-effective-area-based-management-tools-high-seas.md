...
role: lead author
preview: glen_wright_etal_2022_conserving_global_ocean_initial_indications_effective_area_based_management_tools_high_seas
gallery:
...
resources:
  - kind: pdf
    ...
    url: /assets/pdf/glen_wright_etal_2022_conserving_global_ocean_initial_indications_effective_area_based_management_tools_high_seas.pdf
    format: PDF
    local: true
    external: false
    primary: true
