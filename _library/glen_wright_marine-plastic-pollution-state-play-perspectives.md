...
description: Plastic pollution of the ocean is now reaching an alarming level, threatening
  ...
  and fishing.
standfirst: Plastic pollution of the ocean is now reaching an alarming level, threatening
  species and ecosystems, affecting the well-being of populations and costing billions
  of euros every year, in particular through its impact on sectors such as tourism
  and fishing.
...
- kind: slides
  ...
  url: /assets/pdf/glen_wright_2020_marine_plastic_pollution_state_play_perspectives_slides.pdf
  format: PDF
  local: true
  external: false
- kind: zip
...
- kind: video
  ...
  url: https://youtu.be/04yAhVDb4hY
  format: Video
  local: false
  external: true
---
