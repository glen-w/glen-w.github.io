...
abstract: Seeking to fill the gaps in the international legal framework for ocean
  ...
  in areas beyond national jurisdiction (ABNJ). Even if the discussions were generally
  productive, some contentious issues still remain, many of which are fundamental
  to progress and strength of any future agreement. Delegations have much work to
  do in the intersessional period, and the future of the negotiations will likely
  depend on delegations listening carefully and patiently to the views of all other
...
- [PDF](glen_wright_2016_cautious_steps_towards_new_high_seas_agreement.pdf)
- [Additional Link](glen_wright_2016_cautious_steps_towards_new_high_seas_agreement.jpeg)
